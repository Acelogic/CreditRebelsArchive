...
\begin{tikzpicture}[scale=0.7, transform shape]
    ...
    % Level 2: Thick/Thin for Clean, PR/No PR for Dirty
    \node[level2, fill=lightgray] (thick) at (-9,-3) {Thick\\($\geq$4 TLs)};
    \node[level2, fill=lightgray] (thin) at (-3,-3) {Thin\\(<4 TLs)};
    \node[level2, fill=lightgray] (pr) at (4,-3) {PR};
    \node[level2, fill=lightgray] (nopr) at (8,-3) {No PR};
