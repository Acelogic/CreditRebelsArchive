...
\subsection{Scorecard Segmentation}

Score 8 assigns you to one of \textbf{12 scorecards} based on your credit profile. First, you're classified as Clean or Dirty:

\begin{center}
\begin{tikzpicture}
    \tikzstyle{qbox} = [draw=primaryblue, fill=primaryblue!10, rounded corners, minimum width=4cm, minimum height=1cm, align=center, font=\small]
    \tikzstyle{abox} = [draw, rounded corners, minimum width=2.5cm, minimum height=0.8cm, align=center, font=\small]
    \tikzstyle{arrow} = [draw, ->, >=stealth, thick]

    \node[qbox] (q1) at (0,0) {\textbf{Any 60+ day late}\\\textbf{in last 7 years?}};
    \node[abox, fill=successbg] (clean) at (-3,-1.8) {\textbf{NO} $\rightarrow$ Clean};
    \node[abox, fill=dangerbg] (dirty) at (3,-1.8) {\textbf{YES} $\rightarrow$ Dirty};
...
\subsubsection{Clean Scorecards (8 total)}

If you have \textbf{no 60+ day lates}, you're on a Clean scorecard. Three more factors determine which one:
...
\toprule
\rowcolor{tableheader}
\textcolor{white}{\textbf{Factor}} & \textcolor{white}{\textbf{Question}} & \textcolor{white}{\textbf{Result}} \\
\midrule
\textbf{Thickness} & How many accounts do you have? & $\geq$4 = Thick, <4 = Thin \\
\textbf{Maturity} & How old is your oldest account? & $\geq$3 years = Mature, <3 years = Young \\
\textbf{New Revolver} & Any new credit card in last 12 months? & No = No New Rev, Yes = New Rev \\
\bottomrule
\end{tabular}
\end{table}

\textbf{The 8 Clean Scorecards:}
\begin{center}
\small
\begin{tabular}{|c|c|c|c|}
\hline
\rowcolor{successbg!30}
\textbf{Thick + Mature} & \textbf{Thick + Young} & \textbf{Thin + Mature} & \textbf{Thin + Young} \\
\hline
No New Rev & No New Rev & No New Rev & No New Rev \\
\hline
New Rev & New Rev & New Rev & New Rev \\
\hline
\end{tabular}
\end{center}

\subsubsection{Dirty Scorecards (4 total)}

If you have a \textbf{60+ day late or worse}, you're on a Dirty scorecard. Two factors determine which one:
...
\textcolor{white}{\textbf{Factor}} & \textcolor{white}{\textbf{Question}} & \textcolor{white}{\textbf{Result}} \\
\midrule
\textbf{Severity} & Bankruptcy, collections, or public record? & Yes = PR, No = No PR \\
\textbf{Recency} & How recent is the derogatory? & Recent or Mature \\
\bottomrule
\end{tabular}
\end{table}

\textbf{The 4 Dirty Scorecards:}
\begin{center}
\small
\begin{tabular}{|c|c|}
\hline
\rowcolor{dangerbg!30}
\textbf{Public Record (PR)} & \textbf{No Public Record} \\
\hline
PR + Recent & No PR + Recent \\
\hline
PR + Mature & No PR + Mature \\
\hline
\end{tabular}
\end{center}
